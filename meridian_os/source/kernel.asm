;*********************************start of the meridian_os kernel code*********************************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to DINS_OS version 1.0.0", 0x00

	wel1 db	'!==========================================================!', 0x00			

	wel2 db '!!!!!!!!!!!!! Welcome To MERIDIAN_OS !!!!!!!!!!!!! ', 0x00 
	...
	wel7 db ' version 1.0.0 of MERIDIAN_OS by Nadeeshani Nawarathne (SE/2019.043)', 0x00
	...
	strPrompt		db	"meridian_os>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"meridian", 0x00	;OS details
